...
import { useGetProductQuery, useUpdateProductMutation } from "@/features/api/api";
...
export default function SellerProductEditPage() {
  ...
  const { data: existing } = useGetProductQuery(id);
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-6">
      ...
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold tracking-tight text-foreground">{existing ? "Edit Product" : "Add New Product"}</h1>
